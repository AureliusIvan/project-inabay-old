            ...
            <form action ="{{url('/products/edit/'.$product->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="is_open_po" class="form-control">
                                        <option {{$product->is_open_po ? 'selected':''}} value="1">Open PO</option>
                                        <option {{$product->is_open_po ? '':'selected'}} value="0">Tidak Open PO</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="open_po_order_deadline" class="form-control" value="{{$product->open_po_order_deadline}}" placeholder="YYYY-MM-DD" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="disc_type" checked value="rp" /> Rp.
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group text-right" style="padding-top: 20px;">
                                    <div class='checkbox'>
                                        <label>
                                            <input type="checkbox" name="is_sale" value="1" {{$product->is_sale == true ? 'checked':''}} />
                                            &nbsp;&nbsp;<b>Set sebagai sale item.</b>
                                        </label>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="box-footer">
                    <div class="col-md-12 text-right">
                        <a href="/products" class="btn btn-default"><i class="fas fa-chevron-left"></i> Batal</a>
                        <button type="submit" class="btn btn-success"><i class="far fa-save"></i> Ubah Produk</button>
                    </div>
                </div>
            </form>
