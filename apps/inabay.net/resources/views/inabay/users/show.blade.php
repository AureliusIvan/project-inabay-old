    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            <div class="col-md-4 text-right">
                <a href="/members/edit/{{$user->id}}" class="btn btn-warning"><i class="fas fa-edit"></i> Ubah</a>
            </div>
        </div>
        <div class="box-body">
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label>Saldo</label>
                                    <input type="text" name="balance" value="@money($user->balance)" class="form-control" disabled />
                                </div>
                                <div class="form-group">
                                    <label>Poin</label>
                                    <input type="text" name="points" value="@money($user->points)" class="form-control" disabled />
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-info">
