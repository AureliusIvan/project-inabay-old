...
@section('title', 'Admin | Inabay Dropship')
            ...
            <form action="/users/edit/{{$user->id}}" method="post">
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                @can('admin')
                                    <div class="form-group">
                                        <label>Saldo</label>
                                        <input type="text" name="balance" value="{{$user->balance}}" class="form-control" required disabled />
                                    </div>
                                    <div class="form-group">
                                        <label>Poin</label>
                                        <input type="text" name="points" value="{{$user->points}}" class="form-control" required disabled />
                                    </div>
                                @endcan
                            </div>
                        </div>
                                ...
                                @can('superadmin')
                                    <div class="form-group">
                                        ...
                                        <select name="role_id" class="form-control" required>
                                            ...
                                            <option {{$user->role_id == 5 ? "selected":""}} value="5">Finance</option>
                ...
                <div class="box-footer">
                    <div class="col-md-12 text-right">
                        <button type="submit" class="btn btn-success"><i class="far fa-save"></i> {{ isset($self) ? "Simpan" : "Ubah Admin" }}</button>
                    </div>
                </div>
            </form>
